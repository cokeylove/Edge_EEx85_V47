...
ITEEC.ABS:KeilMisc\Obj\CORE_IRQ.OBJ\
            ...
            KeilMisc\Obj\OEM_EDGE.OBJ\
			KeilMisc\Obj\Origa_Ecc.OBJ\
			KeilMisc\Obj\Origa_Gf2nMath.OBJ\
...
#=-----------------------------------------------------------------
KeilMisc\Obj\OEM_HOOK.OBJ:Code\OEM\OEM_HOOK.C $(COREInclude) $(OEMInclude) $(CHIPInclude)
	$(CC) Code\OEM\OEM_HOOK.C $(CDirectives)
	move Code\OEM\OEM_HOOK.OBJ KeilMisc\Obj
	move Code\OEM\OEM_HOOK.LST KeilMisc\Lst
...
KeilMisc\Obj\OEM_EDGE.OBJ:Code\Oem\OEM_EDGE.C $(COREInclude) $(OEMInclude) $(CHIPInclude)
	$(CC) Code\Oem\OEM_EDGE.C $(CDirectives)
	move Code\Oem\OEM_EDGE.OBJ KeilMisc\Obj
	move Code\Oem\OEM_EDGE.LST KeilMisc\Lst

KeilMisc\Obj\Origa_Ecc.OBJ:Code\Oem\Origa_Ecc.C $(COREInclude) $(OEMInclude) $(CHIPInclude)
	$(CC) Code\Oem\Origa_Ecc.C $(CDirectives)
	move Code\Oem\Origa_Ecc.OBJ KeilMisc\Obj
	move Code\Oem\Origa_Ecc.LST KeilMisc\Lst
	
KeilMisc\Obj\Origa_Gf2nMath.OBJ:Code\Oem\Origa_Gf2nMath.C $(COREInclude) $(OEMInclude) $(CHIPInclude)
	$(CC) Code\Oem\Origa_Gf2nMath.C $(CDirectives)
	move Code\Oem\Origa_Gf2nMath.OBJ KeilMisc\Obj
	move Code\Oem\Origa_Gf2nMath.LST KeilMisc\Lst
