...
XBYTE  *idata  Scanner_LOC_Pntr		_at_ 0x5E;
                      //Reserved 0x60 ~ 0x64
...
XBYTE	tmpEvent				_at_ 0x7E;
XBYTE	tmpSSKey2				_at_ 0x7F;
XBYTE  PWRBTN_WDTFLAG           _at_ 0x80;
...
XBYTE  tmpSSKeyCnt			_at_ 0x9F;
XBYTE  nSSKeyTbl			_at_ 0xA0;
XBYTE  ntmpKeyTbl			_at_ 0xA1;
                              //Reserved 0xA2 ~ 0xEF
