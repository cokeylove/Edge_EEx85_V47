...
const sInitGPIOReg code asInitGPIOReg[] =
{
  { &GCR,    GCR_Init      },  //
  { &GCR2,   GCR2_Init     },  //
  { &GPOTA,  0x00          },  // msmart  /AC  //cwy  //AC
#ifdef GCR19_Init  //Input Voltage select Registers
  { &GCR19,  GCR19_Init    },  
#endif  //GCR19_Init  
#ifdef GCR20_Init    //Input Voltage select Registers
  { &GCR20,  GCR20_Init    },  
#endif  //GCR21_Init  
#ifdef GCR21_Init    //Input Voltage select Registers
  { &GCR21,  GCR21_Init    },  
#endif  //GCR21_Init  

#ifdef GPOTA_Init    // Output Type Register
  { &GPOTA,  GPOTA_Init    }, 
#endif //GPOTA_Init
#ifdef GPOTB_Init    // Output Type Register
  { &GPOTB,  GPOTB_Init    }, 
#endif //GPOTB_Init
#ifdef GPOTD_Init    // Output Type Register
  { &GPOTD,  GPOTD_Init    }, 
#endif //GPOTD_Init
#ifdef GPOTE_Init    // Output Type Register
  { &GPOTE,  GPOTE_Init    }, 
#endif //GPOTE_Inits
#ifdef GPOTF_Init    // Output Type Register
  { &GPOTF,  GPOTF_Init    }, 
#endif //GPOTF_Init
#ifdef GPOTH_Init    // Output Type Register
  { &GPOTH,  GPOTH_Init    }, 
#endif //GPOTH_Init
#ifdef GPOTJ_Init    // Output Type Register
  { &GPOTJ,  GPOTJ_Init    }, 
#endif //GPOTJ_Init
