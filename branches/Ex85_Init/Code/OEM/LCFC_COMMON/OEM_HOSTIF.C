...
#ifdef INIT_H2RAM_BASS_ADDRESS
  0xFC ,INIT_H2RAM_BASS_ADDRESS,  // H2RAM-HLPC Base Address Bits [24] (HLPCRAMBA[24])
#endif
  0x30 ,0x01,  // MSWC Shared Memory
//David+ for Port 86 function-->Start
...
//David+ for Port 86 function-->end
};
//----------------------------------------------------------------------------
