...
#if(SUPPORT_KB_Matix == Matrixtable1)
...
{  // 15" US,UK and JP
  ...
  0x15,0x24,0x1D,0x00,0x2D,0x3C,0x43,0x44,0x4D,0x00,0x6A,0x00,0xF1,0x71,0x00,0x00, // 02
  ...
  0x1A,0x21,0x22,0x8D,0x2A,0x3A,0x41,0x49,0x5D,0x89,0xEE,0x00,0x00,0x04,0x71,0x00, // 06
...
#endif //SUPPORT_KB_Matix == Matrixtable1

#if (SUPPORT_KB_Matix == Matrixtable2)
const unsigned char code Rc_ROM_Tables[] =
{  // 15" US,UK and JP
    // Scanner Table 1  - 16 x 8 Scan Table
 //00   01   02   03   04   05   06   07   08   09   10   11   12   13   14   15
  0x0E,0xAD,0xAE,0x2E,0x36,0x55,0xB4,0x4E,0xB5,0xE3,0xE2,0xE9,0xE8,0x00,0x00,0x14, // 00
  0x16,0x1E,0x26,0x25,0x3D,0x3E,0x46,0x45,0xB6,0xB8,0xB7,0xEA,0xEB,0xE0,0x00,0x00, // 01
  0x15,0x1D,0x24,0x2D,0x3C,0x43,0x44,0x4D,0x6A,0x71,0x00,0xBC,0xB9,0x00,0x00,0x00, // 02
  0x0D,0x58,0xAF,0x2C,0x35,0x5B,0xB3,0x54,0x66,0x82,0xB5,0xBA,0xBB,0x00,0x12,0x00, // 03
  0x1C,0x1B,0x23,0x2B,0x3B,0x42,0x4B,0x4C,0x5D,0x00,0x00,0x00,0x00,0x00,0x8E,0x00, // 04
  0xEC,0x61,0xB0,0x34,0x33,0xB2,0x64,0x52,0xB1,0x00,0x00,0x00,0x98,0x11,0x00,0x00, // 05
  0x1A,0x22,0x21,0x2A,0x3A,0x41,0x49,0x5D,0x5A,0x00,0x00,0x00,0x00,0x00,0x59,0x8D, // 06
  0x67,0x00,0x00,0x32,0x31,0x51,0x13,0x4A,0x29,0xE7,0xE5,0x00,0xE6,0x8B,0x00,0x00, // 07
//------------------------------------------------------------------------------------
//    00   01   02   03   04   05   06   07   08   09   0A   0B   0C   0D   0E   0F
//------------------------------------------------------------------------------------
//0- 110  115   45   x    35   36  117  132   41   x   116   x    60   x    83   x
...
#endif  //SUPPORT_KB_Matix == Matrixtable2
...
{  // 15" Brazil
 ...
 //00   01   02   03   04   05   06   07   08   09   10   11   12   13   14   15
  ...
  0x1C,0x1B,0x23,0x2B,0x3B,0x42,0x4B,0x4C,0x5D,0x00,0x00,0x00,0x00,0x00,0x8E,0x00, // 04
  0xEC,0x61,0xB0,0x34,0x33,0xB2,0x64,0x52,0xB1,0x00,0x00,0x00,0x98,0x11,0x00,0x00, // 05
  0x1A,0x22,0x21,0x2A,0x3A,0x41,0x49,0x5D,0x5A,0x00,0x00,0x00,0x00,0x00,0x59,0x51, // 06
  0x67,0x00,0x00,0x32,0x31,0x51,0x13,0x4A,0x29,0xE7,0xE5,0x00,0xE6,0x8B,0x00,0x00, // 07
//------------------------------------------------------------------------------------
//    00   01   02   03   04   05   06   07   08   09   0A   0B   0C   0D   0E   0F
//------------------------------------------------------------------------------------
...
const unsigned char code Rc_LOC_Tables[] =
{  // 14" US, UK and JP.
    // Scanner Table 1  - 16 x 8 Scan Table
//00   01   02    03    04   05   06    07    08   09   10    11   12    13   14    15
...
{  // 14" US, UK and JP.
 ...
 //00   01   02   03   04   05   06   07   08   09   10   11   12   13   14   15
  0x0E,0xAD,0xAE,0x2E,0x36,0x55,0xB4,0x4E,0xB5,0xE3,0xE2,0xE9,0xE8,0x00,0x00,0x14, // 00
  0x16,0x1E,0x26,0x25,0x3D,0x3E,0x46,0x45,0xB6,0xB8,0xB7,0xEA,0xEB,0xE0,0x00,0x00, // 01
  0x15,0x1D,0x24,0x2D,0x3C,0x43,0x44,0x4D,0x6A,0x71,0x00,0x00,0x00,0x00,0x00,0x00, // 02
  0x0D,0x58,0xAF,0x2C,0x35,0x5B,0xB3,0x54,0x66,0x82,0xB5,0xE8,0x00,0x00,0x12,0x00, // 03
  0x1C,0x1B,0x23,0x2B,0x3B,0x42,0x4B,0x4C,0x5D,0x00,0x00,0x00,0x00,0x00,0x8E,0x00, // 04
  0xEC,0x61,0xB0,0x34,0x33,0xB2,0x64,0x52,0xB1,0x00,0x00,0x00,0x98,0x11,0x00,0x00, // 05
  0x1A,0x22,0x21,0x2A,0x3A,0x41,0x49,0x5D,0x5A,0x00,0x00,0x00,0x00,0x00,0x59,0x8D, // 06
  0x67,0x00,0x00,0x32,0x31,0x51,0x13,0x4A,0x29,0xE7,0xE5,0x00,0xE6,0x8B,0x00,0x00, // 07
...
{  // 14" Brazil
 ...
 //00   01   02   03   04   05   06   07   08   09   10   11   12   13   14   15
  ...
  0x15,0x1D,0x24,0x2D,0x3C,0x43,0x44,0x4D,0x6A,0x71,0x00,0x00,0x00,0x00,0x00,0x00, // 02
  0x0D,0x58,0xAF,0x2C,0x35,0x5B,0xB3,0x54,0x66,0x82,0xB5,0xE8,0x00,0x00,0x12,0x00, // 03
  0x1C,0x1B,0x23,0x2B,0x3B,0x42,0x4B,0x4C,0x5D,0x00,0x00,0x00,0x00,0x00,0x00,0x00, // 04
  0xEC,0x61,0xB0,0x34,0x33,0xB2,0x64,0x52,0xB1,0x00,0x00,0x00,0x98,0x11,0x00,0x00, // 05
  0x1A,0x22,0x21,0x2A,0x3A,0x41,0x49,0x5D,0x5A,0x00,0x00,0x00,0x00,0x00,0x59,0x51, // 06
  0x67,0x00,0x00,0x32,0x31,0x51,0x13,0x4A,0x29,0xE7,0xE5,0x00,0xE6,0x8B,0x00,0x00, // 07
};
#endif  //SUPPORT_KB_Matrix == Matrixtable2
...
void HotKey_Fn_F4(BYTE event)
{
  ...
  {  // Enable HotKey
    ...
    {
      if(Ccb42_DISAB_KEY == 0) {
        ECQEvent(MIC_MUTE_EVENT_6A);    // 0x6A Mic Mute.
      }
    }
  }
  else
...
void HotKey_Fn_F5(BYTE event)
{
  ...
  {  // Enable HotKey
    ...
    if(event != BREAK_EVENT)
    {
      ...
      {
        if(Ccb42_DISAB_KEY == 0) {
          ECQEvent(LCD_BRIG_DEC_EVENT_15);  // 0x15 Brightness down.
        }
      }
      else
      {
...
void HotKey_Fn_F6(BYTE event)
{
  ...
  {  // Enable HotKey
    ...
    if(event != BREAK_EVENT)
    {
      ...
      {
        if(Ccb42_DISAB_KEY == 0) {
          ECQEvent(LCD_BRIG_INC_EVENT_14);  // 0x14 Brightness up.
        }
      }
      else
      {
...
//{
  if(Ccb42_DISAB_KEY == 0) {
    ECQEvent(PRESENT_DIR_EVENT_16);  // 0x16 Presentation Direct.
  }
//}
#endif
}
...
void HotKey_Fn_F7(BYTE event)
{
  ...
  {  // Enable HotKey
    ...
    {
      if(Ccb42_DISAB_KEY == 0) {
        ECQEvent(PRESENT_DIR_EVENT_16);  // 0x16 Presentation Display Mode.
      }
    }
  }
  else
...
void HotKey_Fn_F8(BYTE event)
{
  ...
  {  // Enable HotKey
    ...
    {
      if(Ccb42_DISAB_KEY == 0) {
        ECQEvent(WIRELESS_EVENT_64);    // 0x64 Wirless Radio notify.
      }
    }
  }
  else
...
void HotKey_Fn_F10(BYTE event)
{
  ...
  {  // Enable HotKey
    if ( IS_MASK_SET(SYS_MISC1, ACPI_OS) )
    {
      ...
      {
        if(Ccb42_DISAB_KEY == 0) {
          ECQEvent(Bluetooth_EVENT_60);    // 0x60 BlueTooth
        }
      }
...
void HotKey_Fn_F11(BYTE event)
{
  ...
  {  // Enable HotKey
    if ( IS_MASK_SET(SYS_MISC1, ACPI_OS) )
    {
      ...
      {
        if(Ccb42_DISAB_KEY == 0) {
          ECQEvent(KBManage_EVENT_61);    // 0x61 Keyboard Manager 
        }
      }
    }
  }
...
void HotKey_Fn_F12(BYTE event)
{
  ...
  {  // Enable HotKey
    if ( IS_MASK_SET(SYS_MISC1, ACPI_OS) )
    {
      ...
      {
        if(Ccb42_DISAB_KEY == 0) {
          ECQEvent(UserDefiuned_EVENT_62);    // 0x62 User Defined Key 
        }
      }
    }
  }
...
void HotKey_Fn_SPACE(BYTE event)
{
  ...
  {  // Enable HotKey
    ...
    IS_MASK_CLEAR(KBL_Status,PowerOnCheck) && 
#endif
#if KB_FnSticky_Key
	(!FnStickyGET )
#endif //KB_FnSticky_Key      
...
//        		SET_MASK(KBL_Status,TargetChange);
//        		SET_MASK(KBL_Status,Frone);
          }
...
//        		SET_MASK(KBL_Status,TargetChange);
//        		CLEAR_MASK(KBL_Status,Frone);
          }
//          if(IS_MASK_SET(KBL_Status,TargetChange))
//          {
	          //if(IS_MASK_SET(KBL_Status,Frone))
          	...
          	else	
	        {
          	...
          	//CLEAR_MASK(KBL_Status,TargetChange);
//          }
		}
...
const BYTE code windows_lcok[] = {0xE0,0x1F, 0x4B,   0xF0,0x4B,    0xE0,0xF0,0x1F,  0x00};

#endif //CS13KB

#if (Support_Keyboard == CS16KB)
// "(" 
//const BYTE code Keypad_hotkey2[] = {0x12,0x46,  0xF0,0x46, 0xF0,0x12,  0x00};

// ")" 
//const BYTE code Keypad_hotkey3[] = {0x12,0x45,  0xF0,0x45, 0xF0,0x12,  0x00};

// "("  
//const BYTE code JP_Keypad_hotkey2[] = {0x12,0x3E,  0xF0,0x3E, 0xF0,0x12,  0x00};

// ")" 
//const BYTE code JP_Keypad_hotkey3[] = {0x12,0x46,  0xF0,0x46, 0xF0,0x12,  0x00};
...
//keypad hotkey1 "="
  if (temp_scanner_state.field.tFN) {
  	if (event == MAKE_EVENT) {
    	if ( IS_MASK_SET(SYS_MISC1, ACPI_OS)){
      		ECQEvent(HOTKEY_calculator);    
    	}
  	}
  }else{
   // if((event == MAKE_EVENT)||(event == REPEAT_EVENT))
	//	{simple_code(0x55 ,event);}
	Hook_Keyboard_LanguageID(event, Hotkey_1_EN);
  }
#endif //CS16KB
}
...
//keypad hotkey2 "("
 // if ((event == MAKE_EVENT) || (event == REPEAT_EVENT)) {
    //if (GET_KEYBOARD_TYPE)   //JP keyboard
    //  {Buffer_String(JP_Keypad_hotkey2);}     /* Buffer pre-string. */
  //  else                     //US keyobard
    //  {Buffer_String(Keypad_hotkey2);}        /* Buffer pre-string. */
 // }       
   Hook_Keyboard_LanguageID(event, Hotkey_2_EN);
#endif //CS16KB
...
//keypad hotkey3 ")"
 // if ((event == MAKE_EVENT) || (event == REPEAT_EVENT)) {
  //  if (GET_KEYBOARD_TYPE)   //JP keyboard
   //   {Buffer_String(JP_Keypad_hotkey3);}     /* Buffer pre-string. */
   // else                     //US keyobard
     // {Buffer_String(Keypad_hotkey3);}        /* Buffer pre-string. */
 // }    
   Hook_Keyboard_LanguageID(event, Hotkey_3_EN);
#endif //CS16KB
}
...
// Force set2 to send combination key code to determine FnFunc in Hotkey function
              //Fn    //Fn
const BYTE code ss2_AD[] = {0xD0,  0xD0};  // F1
const BYTE code ss2_AE[] = {0xD1,  0xD1};  // F2
const BYTE code ss2_AF[] = {0xD2,  0xD2};  // F3
const BYTE code ss2_B0[] = {0xD3,  0xD3};  // F4
const BYTE code ss2_B1[] = {0xD4,  0xD4};  // F5
const BYTE code ss2_B2[] = {0xD5,  0xD5};  // F6
const BYTE code ss2_B3[] = {0xD6,  0xD6};  // F7
const BYTE code ss2_B4[] = {0xD7,  0xD7};  // F8
const BYTE code ss2_B5[] = {0xD8,  0xD8};  // F9
const BYTE code ss2_B6[] = {0xD9,  0xD9};  // F10
const BYTE code ss2_B7[] = {0xDA,  0xDA};  // F11
const BYTE code ss2_B8[] = {0xDB,  0xDB};  // F12
const BYTE code ss2_B9[] = {0xDE,  0xDE};  // (
const BYTE code ss2_BA[] = {0xDF,  0xDF};  // )
const BYTE code ss2_BB[] = {0xDD,  0xDD};  // (
const BYTE code ss2_BC[] = {0xE0,  0xE0};  // )

#else
            //Normal  //Fn
const BYTE code ss2_AD[] = {0x05,  0xD0};  // F1
const BYTE code ss2_AE[] = {0x06,  0xD1};  // F2
const BYTE code ss2_AF[] = {0x04,  0xD2};  // F3
const BYTE code ss2_B0[] = {0x0C,  0xD3};  // F4
const BYTE code ss2_B1[] = {0x03,  0xD4};  // F5
const BYTE code ss2_B2[] = {0x0B,  0xD5};  // F6
const BYTE code ss2_B3[] = {0x80,  0xD6};  // F7
const BYTE code ss2_B4[] = {0x0A,  0x77};  // F8
const BYTE code ss2_B5[] = {0x01,  0xD8};  // F9
const BYTE code ss2_B6[] = {0x09,  0xD9};  // F10
const BYTE code ss2_B7[] = {0x78,  0xDA};  // F11
const BYTE code ss2_B8[] = {0x07,  0xDB};  // F12
#endif
...
{                      // Keyboard matrix index
  ...
  // F1~F12 hotkeys -->
    ...
    {0x20, ss2_B9 },     /* index = 1Ch */  // 0xB9
    {0x20, ss2_BA },     /* index = 1Ch */  // 0xBA
    {0x20, ss2_BB },     /* index = 1Ch */  // 0xBB
    {0x20, ss2_BC }     /* index = 1Ch */  // 0xBC
    // F1~F12 hotkeys <--
};
                      // Reserved 0xB9 ~ 0xDF
...
{               //  Normal     Fn         // Keyboard matrix index
 ...
 0x55, 0xAB,   // =	             Caluator         	// 0xF4
 0x66, 0x86,   // Back space    Sleep	 // 0xF5
...
const FnKeyOverrideStruct code LcfcEdgeKeyOverrideTable[] =
{ 
//  Normal      Fn         // Keyboard matrix index
  { 0x32,       0x92 },    // B,      Break
  { 0x1B,       0xC1 },    // S,      SysRq
 ...
 * ------------------------------------------------------------------------- */
#if KB_FnSticky_Key
const unsigned char code FNFunctionTable[] =
{ 
...
void FnEquSAFunc(BYTE event)
{
  ...
  Port80Count = sizeof(Port80_Data)/sizeof(Port80_Data[0]); // 15;

  if(IS_MASK_CLEAR(cSPIEEPROM,cSPI_ROMCopyStart)) {
    SET_MASK(CombineKeyStatus,HotkeyStoreROM);
    WRITE_DATA2EEPROM(&BRAM3F, 1 ,EEPROM_Bank7, EEPROM_SAVE_PORT80);
    ...
    Oem_hook_FnEquIOFunc();
//save EC ram 0x100 ~ 0x300 to BANK4 ~ BANK6
    SET_MASK(CombineKeyStatus,HotkeyStoreROM);
    WRITE_DATA2EEPROM(&SysPowState, 0x300, EEPROM_Bank4, 0x00);   
//save GPIO 0x1600 ~ 0x167F to BANK3 0x00 to 0x7F
    SET_MASK(CombineKeyStatus,HotkeyStoreROM);
    WRITE_DATA2EEPROM(&GCR, 0x80, EEPROM_Bank3, 0x00);     
  }
}
...
// =	-> Fn
  ...
  if ((temp_scanner_state.field.tFN)||(FN_ANK == 0x01)) { // Fn key + any key
  ...
  //
    ...
    {
      ECQEvent(HOTKEY_PrtSc_65);    // 0x65 snipping tool.
    }  
...
void Hook_keyboard_Oem(union KEY *key,  BYTE event)
{
  if( FnCtrlSWAPGet )
  {
    if((key->field.input== 0x00)&&(key->field.output == 0x0F))// LCtrl
    {
      // Replaced by Fn key
      ...
      key->field.input = 0x00;
      key->field.output = 0x0F; // LCtrl
    }
  }

#if KB_FnSticky_Key
  //if (IS_MASK_SET(SYS_MISC1, ACPI_OS) && FnStickyGET && ((key->field.input == 0x04)&&(key->field.output == 0x0E)) && (event==BREAK_EVENT)){  //sticky support & Fn press
  if (IS_MASK_SET(SYS_MISC1, ACPI_OS) && FnStickyGET && ((key->field.input == 0x04)&&(key->field.output == 0x0E)) && (event==MAKE_EVENT)){  //sticky support & Fn press
//  Fn key status 
//  00: unlock
//  01: sticky
//  10: lock  
...
void Hook_Setup_Scanner_Pntr(void)
{
  ...
  Scanner_LOC_Pntr   = &KB_LOC_Table;   //ivan  
  LoadKBMatrixToRAM();
  #else
...
//ivan		
    ...
    {
        Tmp_XPntr = ( KB_LOC_Table + ITempB06 );
        *Tmp_XPntr = Rc_LOC_Tables[ITempB06];
//ivan	
...
{
  if( IS_MASK_SET(SYS_MISC1, ACPI_OS) )  //under ACPI
  {
#if KB_FnSticky_Key 
    if (FnStickyGET){
    ...
    if ((temp_scanner_state.field.tFN || (IS_MASK_SET(EVT_STATUS1,KB_FN_Status)&&(!FnCtrlSWAPGet)))){
     ...
     if( IS_MASK_SET(pProject0,b6PostHotKey) )
       {return(0);}
...
#if (Support_Keyboard == CS16KB)
// shift
const BYTE code HotkeyX_Shift[] = {0x12, 0x00};
const BYTE code HotkeyX_Shift_release[] = {0xF0, 0x12, 0x00};
// Swiss
const BYTE code CH_Keypad_hotkey1[] = {0x45, 0xF0,0x45, 0x00};     // shift
const BYTE code CH_Keypad_hotkey2[] = {0x3E, 0xF0,0x3E, 0x00};     // shift
const BYTE code CH_Keypad_hotkey3[] = {0x46, 0xF0,0x46, 0x00};     // shift
//Belgian
const BYTE code BE_Keypad_hotkey1[] = {0x4A, 0xF0,0x4A, 0x00};
const BYTE code BE_Keypad_hotkey2[] = {0x2E, 0xF0,0x2E, 0x00};
const BYTE code BE_Keypad_hotkey3[] = {0x4E, 0xF0,0x4E, 0x00};
//Czech
const BYTE code CZ_Keypad_hotkey1[] = {0x4E, 0xF0,0x4E, 0x00};
const BYTE code CZ_Keypad_hotkey2[] = {0x5B, 0xF0,0x5B, 0x00};     // shift
const BYTE code CZ_Keypad_hotkey3[] = {0x5B, 0xF0,0x5B, 0x00};
//Slovakian
const BYTE code SK_Keypad_hotkey1[] = {0x4E, 0xF0,0x4E, 0x00};
const BYTE code SK_Keypad_hotkey2[] = {0x5B, 0xF0,0x5B, 0x00};     // shift
const BYTE code SK_Keypad_hotkey3[] = {0x5D, 0xF0,0x5D, 0x00};     // shift
//French
const BYTE code FR_Keypad_hotkey1[] = {0x55, 0xF0,0x55, 0x00};
const BYTE code FR_Keypad_hotkey2[] = {0x2E, 0xF0,0x2E, 0x00};
const BYTE code FR_Keypad_hotkey3[] = {0x4E, 0xF0,0x4E, 0x00};
//Hungarian
const BYTE code HU_Keypad_hotkey1[] = {0x3D, 0xF0,0x3D, 0x00};     // shift
const BYTE code HU_Keypad_hotkey2[] = {0x3E, 0xF0,0x3E, 0x00};     // shift
const BYTE code HU_Keypad_hotkey3[] = {0x46, 0xF0,0x46, 0x00};     // shift
// Dutch
const BYTE code NL_Keypad_hotkey1[] = {0x4A, 0xF0,0x4A, 0x00};     // shift
const BYTE code NL_Keypad_hotkey2[] = {0x3E, 0xF0,0x3E, 0x00};     // shift
const BYTE code NL_Keypad_hotkey3[] = {0x46, 0xF0,0x46, 0x00};     // shift
//Japanese
const BYTE code JP_Keypad_hotkey1[] = {0x4E, 0xF0,0x4E, 0x00}; //{0x55, 0xF0,0x55, 0x00};// {0x4E, 0xF0,0x4E, 0x00};     // shift
const BYTE code JP_Keypad_hotkey2[] ={0x3E, 0xF0,0x3E, 0x00};  //{0x46, 0xF0,0x46, 0x00}; //{0x3E, 0xF0,0x3E, 0x00};     // shift
const BYTE code JP_Keypad_hotkey3[] ={0x46, 0xF0,0x46, 0x00};// {0x45, 0xF0,0x45, 0x00}; //{0x46, 0xF0,0x46, 0x00};     // shift
//US 
const BYTE code Keypad_hotkey1[] =    {0x55, 0xF0,0x55, 0x00};
const BYTE code Keypad_hotkey2[] =    {0x46, 0xF0,0x46, 0x00};     // shift
const BYTE code Keypad_hotkey3[] =    {0x45, 0xF0,0x45, 0x00};     // shift
#endif //(Support_Keyboard == CS16KB)

void Hook_Keyboard_LanguageID(BYTE event, BYTE Hotkey_ID)
{
  BYTE *buff_pntr;
  BOOL temp_shift;
	switch (KEYBOARD_TYPE)
  {		 
    case Keyboard_LanguageID_Swiss: 
      if(Hotkey_ID == Hotkey_1_EN) {  //shift
//const BYTE code CH_Keypad_hotkey1[] = {0x12,0x45,  0xF0,0x45, 0xF0,0x12,  0x00};
        buff_pntr = CH_Keypad_hotkey1;
        temp_shift = TRUE;       
      } 
      else if(Hotkey_ID == Hotkey_2_EN)  //shift
      {
//const BYTE code CH_Keypad_hotkey2[] = {0x12,0x3E,  0xF0,0x3E, 0xF0,0x12,  0x00};
        buff_pntr = CH_Keypad_hotkey2;
        temp_shift = TRUE;         
      }
      else   //shift
      {
//const BYTE code CH_Keypad_hotkey3[] = {0x12,0x46,  0xF0,0x46, 0xF0,0x12,  0x00};
        buff_pntr = CH_Keypad_hotkey3;
        temp_shift = TRUE;            
      }  
      break;
			 
	  case Keyboard_LanguageID_Belgian: 
      if(Hotkey_ID == Hotkey_1_EN) {         
//const BYTE code BE_Keypad_hotkey1[] = {0x4A,  0xF0,0x4A,  0x00};
        buff_pntr = BE_Keypad_hotkey1;
        temp_shift = FALSE; 
      }   
      else if(Hotkey_ID == Hotkey_2_EN)
      {
//	const BYTE code BE_Keypad_hotkey2[] = {0x2E,  0xF0,0x2E,  0x00};
        buff_pntr = BE_Keypad_hotkey2;
        temp_shift = FALSE; 
      }
      else
      {
//const BYTE code BE_Keypad_hotkey3[] = {0x4E,  0xF0,0x4E,  0x00};
        buff_pntr = BE_Keypad_hotkey3;
        temp_shift = FALSE; 
      }   
      break;
			 			 
	  case Keyboard_LanguageID_Czech:   //shift
      if(Hotkey_ID == Hotkey_1_EN) {    
//const BYTE code CZ_Keypad_hotkey1[] = {0x4E, 0xF0,0x4E, 0x00};
        buff_pntr = CZ_Keypad_hotkey1;
        temp_shift = FALSE; 
      } 
      else if(Hotkey_ID == Hotkey_2_EN)  //shift
      {
//const BYTE code CZ_Keypad_hotkey2[] = {0x12,0x5B,  0xF0,0x5B, 0xF0,0x12,  0x00};
        buff_pntr = CZ_Keypad_hotkey2;
        temp_shift = TRUE; 
      }
      else
      {
//const BYTE code CZ_Keypad_hotkey3[] = {0x5B, 0xF0,0x5B, 0x00};
        buff_pntr = CZ_Keypad_hotkey3;
        temp_shift = FALSE; 
      }
      break;	

    case Keyboard_LanguageID_Slovakian:  
	    if(Hotkey_ID == Hotkey_1_EN) {      
//const BYTE code SK_Keypad_hotkey1[] = {0x4E,  0xF0,0x4E,  0x00};
        buff_pntr = SK_Keypad_hotkey1;
        temp_shift = FALSE; 
      }  
      else if(Hotkey_ID == Hotkey_2_EN)  //shift
      {
//const BYTE code SK_Keypad_hotkey2[] = {0x12,0x5B,  0xF0,0x5B, 0xF0,0x12,  0x00};
        buff_pntr = SK_Keypad_hotkey2;
        temp_shift = TRUE;               
      }
      else   //shift
      {
//const BYTE code SK_Keypad_hotkey3[] = {0x12,0x5D,  0xF0,0x5D, 0xF0,0x12,  0x00};
        buff_pntr = SK_Keypad_hotkey3;
        temp_shift = TRUE;                        
      }  
      break;

    case Keyboard_LanguageID_French:
      if(Hotkey_ID == Hotkey_1_EN) {
//const BYTE code FR_Keypad_hotkey1[] = {0x55,  0xF0,0x55,  0x00};
        buff_pntr = FR_Keypad_hotkey1;
        temp_shift = FALSE;    
      } 
      else if(Hotkey_ID == Hotkey_2_EN)
      {
//const BYTE code FR_Keypad_hotkey2[] = {0x2E,  0xF0,0x2E,  0x00};
        buff_pntr = FR_Keypad_hotkey2;
        temp_shift = FALSE;  
      }
      else
      {
//const BYTE code FR_Keypad_hotkey3[] = {0x4E,  0xF0,0x4E,  0x00};
        buff_pntr = FR_Keypad_hotkey3;
        temp_shift = FALSE;  
      }
      break;

    case Keyboard_LanguageID_Hungarian:    
      if(Hotkey_ID == Hotkey_1_EN) {    //shift
//const BYTE code HU_Keypad_hotkey1[] = {0x12,0x3D,  0xF0,0x3D, 0xF0,0x12,  0x00};
        buff_pntr = HU_Keypad_hotkey1;
        temp_shift = TRUE;              
      } 
      else if(Hotkey_ID == Hotkey_2_EN)  //shift
      {
//const BYTE code HU_Keypad_hotkey2[] = {0x12,0x3E,  0xF0,0x3E, 0xF0,0x12,  0x00};
        buff_pntr = HU_Keypad_hotkey2;
        temp_shift = TRUE;            
      }
      else    //shift
      {
//const BYTE code HU_Keypad_hotkey3[] = {0x12,0x46,  0xF0,0x46, 0xF0,0x12,  0x00};
        buff_pntr = HU_Keypad_hotkey3;
        temp_shift = TRUE;            
      }  
      break;

    case Keyboard_LanguageID_Dutch:    
      if(Hotkey_ID == Hotkey_1_EN)  {     //shift    
//const BYTE code NL_Keypad_hotkey1[] = {0x12,0x4A,  0xF0,0x4A, 0xF0,0x12,  0x00};
        buff_pntr = NL_Keypad_hotkey1;
        temp_shift = TRUE;       
      }  
      else if(Hotkey_ID == Hotkey_2_EN)   //shift
      {
//const BYTE code NL_Keypad_hotkey2[] = {0x12,0x3E,  0xF0,0x3E, 0xF0,0x12,  0x00};
        buff_pntr = NL_Keypad_hotkey2;
        temp_shift = TRUE;           
      }
      else    //shift
      {
//const BYTE code NL_Keypad_hotkey3[] = {0x12,0x46,  0xF0,0x46, 0xF0,0x12,  0x00};
        buff_pntr = NL_Keypad_hotkey3;
        temp_shift = TRUE;        
      }  
      break;
			 
    case Keyboard_LanguageID_Japanese:   //shift
      if(Hotkey_ID == Hotkey_1_EN)    //shift
      {
//const BYTE code JP_Keypad_hotkey1[] = {0x12,0x4E,  0xF0,0x4E, 0xF0,0x12,  0x00};
        buff_pntr = JP_Keypad_hotkey1;
        temp_shift = TRUE;   
      } 
      else if(Hotkey_ID == Hotkey_2_EN)   //shift
      {
//const BYTE code JP_Keypad_hotkey2[] = {0x12,0x3E,  0xF0,0x3E, 0xF0,0x12,  0x00};
        buff_pntr = JP_Keypad_hotkey2;
        temp_shift = TRUE;        
      }
      else   //shift
      {
//const BYTE code JP_Keypad_hotkey3[] = {0x12,0x46,  0xF0,0x46, 0xF0,0x12,  0x00};
        buff_pntr = JP_Keypad_hotkey3;
        temp_shift = TRUE;            
      }
      break;

    default:    //shift
      if(Hotkey_ID == Hotkey_1_EN)//US
      {
//const BYTE code Keypad_hotkey1[] = {0x55, 0xF0,0x55, 0x00};
        buff_pntr = Keypad_hotkey1;
        temp_shift = FALSE;   
      }  
      else if(Hotkey_ID == Hotkey_2_EN)   //shift
      {
//const BYTE code Keypad_hotkey2[] = {0x12,0x46,  0xF0,0x46, 0xF0,0x12,  0x00};
        buff_pntr = Keypad_hotkey2;
        temp_shift = TRUE;  
      }
      else   //shift
      {
//const BYTE code Keypad_hotkey3[] = {0x12,0x45,  0xF0,0x45, 0xF0,0x12,  0x00};      
        buff_pntr = Keypad_hotkey3;
        temp_shift = TRUE;  		
      } 
      break;
  }
  ...
  if((event == MAKE_EVENT) || (event == REPEAT_EVENT)) {
    if ((temp_scanner_state.field.tLEFT | temp_scanner_state.field.tRIGHT) || (temp_shift == FALSE)){
      Buffer_String(buff_pntr);
    }else{
      Buffer_String(HotkeyX_Shift);       
      Buffer_String(buff_pntr);
    } 
  }

  if (event == BREAK_EVENT) {
    if ((!(temp_scanner_state.field.tLEFT | temp_scanner_state.field.tRIGHT)) && (temp_shift == TRUE)){
      Buffer_String(HotkeyX_Shift_release);        	   
    } 
  }  
}
